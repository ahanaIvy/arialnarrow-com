  ...
  return (
    <>
      ...
      <Schema 
        type="WebPage" 
        data={{
          name: 'Arial Narrow Styles',
          description: 'Explore all available styles of Arial Narrow.',
        }}
      />
      ...
      <Container className="py-8 md:py-12">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground mb-10">
            Arial Narrow comes in four distinct styles, each optimized for 
            different typographic applications. Explore each one below.
          </p>
