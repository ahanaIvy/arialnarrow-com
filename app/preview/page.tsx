...
export default function PreviewPage() {
  return (
    <>
      <SEO 
        title="Arial Narrow Preview — Test Font with Custom Text"
        description="Test Arial Narrow with your own text. Customize font size, weight, and style. Preview how Arial Narrow looks in real-time."
        keywords={['Arial Narrow preview', 'Arial Narrow generator', 'font preview', 'test font']}
      />
